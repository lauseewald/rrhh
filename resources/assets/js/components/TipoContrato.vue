            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" @click="abrirModal('tipoContrato','registrar')" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="text" v-model="buscar" @keyup.enter="listarTipoContrato(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">
                                    <button type="submit" @click="listarTipoContrato(1,buscar,criterio)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="tipoContrato in arrayTipoContrato" :key="tipoContrato.id">
                                    ...
                                    <td>
                                        <button type="button" @click="abrirModal('tipoContrato','actualizar',tipoContrato)" class="btn btn-warning btn-sm">
                                          <i class="icon-pencil"></i>
                                        </button> &nbsp;
                                        <template v-if="tipoContrato.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarTipoContrato(tipoContrato.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarTipoContrato(tipoContrato.id)">
                        ...
                        <div class="modal-body">
                            <form id="modal-form" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre del Tipo de Contrato">
    ...
    export default {
        ...
        methods : {
            listarTipoContrato (page,buscar,criterio){
                let me=this;
                var url= '/tipoContrato?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            desactivarTipoContrato(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put('/tipoContrato/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarTipoContrato(1,'','nombre');
                        swal(
            ...
            activarTipoContrato(id){
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put('/tipoContrato/activar',{
                        'id': id
                    }).then(function (response) {
                        me.listarTipoContrato(1,'','nombre');
                        swal(
